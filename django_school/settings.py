...
# MEDIA_URL is the URL that will be used to access the media files
MEDIA_URL = '/media/'

# MEDIA_ROOT is the absolute file system path to the directory where media files will be stored
